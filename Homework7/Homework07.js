...
async function main() {
    try {
        ...
        textOverlay2 = setupText(canvas, "shading mode: " + shadingMode + " (" + renderingMode + ")", 2);
        ...
        textOverlay6 = setupText(canvas, "press 'g' to switch to Gouraud shading", 7);
        textOverlay6 = setupText(canvas, "press 'p' to switch to Phong shading", 8);
